...
static const char* TAG = "EPaper::Font::CourierNew24pt";

CourierNew24pt::CourierNew24pt() {
    Width = 17;
    Height = 24;
};

bool CourierNew24pt::hasCharacter(char c) {
    return c >= ' ' && c <= '}';
};

uint8_t* CourierNew24pt::getCharacter(char c) {
...
uint8_t* CourierNew24pt::getFontTable() {
    return fontTable;
};

uint8_t CourierNew24pt::fontTable[] = {
// @0 ' ' (17 pixels wide)
        0x00, 0x00, 0x00, //
        0x00, 0x00, 0x00, //
        0x00, 0x00, 0x00, //
