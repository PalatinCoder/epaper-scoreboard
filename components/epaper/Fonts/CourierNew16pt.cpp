...
static const char* TAG = "EPaper::Font::CourierNew16pt";

CourierNew16pt::CourierNew16pt() {
    Width = 11;
    Height = 16;
};

bool CourierNew16pt::hasCharacter(char c) {
    return c >= ' ' && c <= '}';
};

uint8_t* CourierNew16pt::getCharacter(char c) {
    uint16_t charLength = Height * (Width / 8 + (Width % 8  ? 1 : 0));
    uint16_t charOffset = (c - ' ') * charLength;
...
uint8_t* CourierNew16pt::getFontTable() {
    return fontTable;
};

uint8_t CourierNew16pt::fontTable[] = {
// @0 ' ' (11 pixels wide)
        0x00, 0x00, //
        0x00, 0x00, //
        0x00, 0x00, //
