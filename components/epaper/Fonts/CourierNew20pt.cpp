...
static const char* TAG = "EPaper::Font::CourierNew20pt";

CourierNew20pt::CourierNew20pt() {
    Width = 14;
    Height = 20;
};

bool CourierNew20pt::hasCharacter(char c) {
    return c >= ' ' && c <= '}';
};

uint8_t* CourierNew20pt::getCharacter(char c) {
...
uint8_t* CourierNew20pt::getFontTable() {
    return fontTable;
};

uint8_t CourierNew20pt::fontTable[] = { 
// @0 ' ' (14 pixels wide)
        0x00, 0x00, //
        0x00, 0x00, //
        0x00, 0x00, //
